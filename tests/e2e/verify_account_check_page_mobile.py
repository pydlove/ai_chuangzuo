#!/usr/bin/env python3
"""Verify mobile account check page hero header."""
import os
...
def main():
    with sync_playwright() as p:
        ...
        page.goto(f"{BASE}/console/account-check", wait_until="networkidle")
        try:
        ...
        hero = page.query_selector(".account-check-hero")
        logo = page.query_selector(".account-check-hero-logo")
        ok = hero is not None and logo is not None
        page.screenshot(path=f"{SHOTS}/account_check_page_mobile.png")
