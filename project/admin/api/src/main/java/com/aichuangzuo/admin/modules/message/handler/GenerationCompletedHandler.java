...
public class GenerationCompletedHandler implements MessageNotifyHandler {

    public static final String BIZ_TYPE = "generation_completed";
    ...
    public void dispatch(NotifyOutbox row) {
        ...
        if (taskId == null || userId == null || articleBizNo == null) {
            throw new IllegalArgumentException(
                    "generation_completed payload 缺失必填字段：taskId/userId/articleBizNo");
        }
        notifyClient.notifyCompleted(taskId, userId, articleBizNo, articleTitle);
    }
    ...
    private Map<String, Object> parse(String json) {
        try {
            ...
            throw new IllegalArgumentException("解析 generation_completed payload 失败: " + e.getMessage(), e);
        }
    }
