<template>
  <div class="account-check-page">
    <div class="account-check-hero">
      <div class="account-check-hero-main">
        ...
        <p class="account-check-hero-desc">
          检测账号昵称与自媒体定位是否契合，获取优化建议
        </p>
      </div>
      <div class="account-check-hero-icon-wrap">
        <img
          class="account-check-hero-icon"
          src="/assets/images/账号检测宣传图-v1.png"
          alt="账号检测"
        />
      </div>
    </div>

    <div class="account-check-page-body">
      <a-alert
...
:global(.account-check-page .ant-btn-primary) {
  background: var(--color-primary);
  border-color: var(--color-primary);
  color: #fff;
}
:global(.account-check-page .ant-btn-primary:hover),
:global(.account-check-page .ant-btn-primary:focus) {
  background: var(--color-primary-hover);
  border-color: var(--color-primary-hover);
  color: #fff;
}
:global(.account-check-page .ant-btn-primary:disabled) {
  color: rgba(0, 0, 0, 0.25);
  background: #f5f5f5;
  border-color: #d9d9d9;
}
:global(.account-check-page .ant-radio-checked .ant-radio-inner) {
  border-color: var(--color-primary);
  background: var(--color-primary);
}
:global(.account-check-page .ant-radio-wrapper:hover .ant-radio),
:global(.account-check-page .ant-radio:hover .ant-radio-inner) {
  border-color: var(--color-primary);
}
:global(.account-check-page .ant-input:hover),
:global(.account-check-page .ant-input:focus),
:global(.account-check-page .ant-input-focused) {
  border-color: var(--color-primary);
}
:global(.account-check-page .ant-input:focus),
:global(.account-check-page .ant-input-focused) {
...
@media (max-width: 768px) {
  ...
  .account-check-hero::before,
  .account-check-hero::after {
    content: '';
    position: absolute;
    border-radius: 50%;
  ...
  .account-check-hero-main {
    position: relative;
    z-index: 1;
    flex: 1;
    min-width: 0;
  }
  .account-check-hero-logo {
    height: 36px;
    width: auto;
    display: block;
  }
  .account-check-hero-desc {
    margin: 8px 0 0;
    font-size: 12px;
    line-height: 1.5;
    color: var(--color-text-secondary);
  }
  .account-check-hero-icon-wrap {
    width: 100px;
    height: 100px;
    display: flex;
    align-items: center;
