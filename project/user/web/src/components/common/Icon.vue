...
const ICONS = {
  ...
  'id-card': '<rect x="4" y="4" width="16" height="16" rx="2" ry="2" /><polyline points="22 6 12 13 2 6" />',
  ...
  picture: '<rect x="3" y="3" width="18" height="18" rx="2" ry="2" /><circle cx="8.5" cy="8.5" r="1.5" /><polyline points="21 15 16 10 5 21" />',
  ...
  wallet: '<path d="M20 12V8H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h14v-4" /><path d="M20 12h-6a2 2 0 0 0-2 2v0a2 2 0 0 0 2 2h6" />',
  shield: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />',
  crown: '<path d="M2 7l2 12h16l2-12-4 3-4-7-4 7-4-3z" />',
  'message-circle': '<path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" />',
  fire: '<path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-2.072-2.143-3.5-1-3.5 3-3.5 8.5 0 12 2.5 2.5 6.5 3.5 10 1.5 4-2 5-6 3-10-1-2-3-3-5-3-1 0-2 .5-2.5 1.5" />',
  coin: '<circle cx="12" cy="12" r="9"/><path d="M9 8l3 4 3-4"/><path d="M9 16h6"/><path d="M12 12v4"/>',
  'pie-chart': '<path d="M12 2a10 10 0 1 0 10 10H12V2z"/><path d="M12 2a10 10 0 0 1 10 10"/><path d="M12 12L2.5 6.5"/>',
  ...
  ticket: '<path d="M2 9a3 3 0 0 1 3-3h.93a2 2 0 0 0 1.66-.9l.82-1.2A2 2 0 0 1 11.07 2h1.86a2 2 0 0 1 1.66.9l.82 1.2a2 2 0 0 0 1.66.9H19a3 3 0 0 1 3 3"/><path d="M2 9v9a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3V9"/><line x1="8" y1="16" x2="8.01" y2="16"/>',
