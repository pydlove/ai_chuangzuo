    ...
    articles: [
      {
        ...
        content: `
          ...
          <p>不管是公众号长文、小红书笔记、今日头条文章，还是抖音图文、百家号、B站专栏内容，都可以一次生成，复制到对应平台直接发布。</p>
        `
      },
      {
        id: 'what-output',
        ...
        content: `
          ...
          <p>生成后可直接导出 Word，或复制正文到公众号、小红书、抖音、今日头条、百家号、B站等平台发布。</p>
        `
      },
      {
        id: 'what-platforms',
    ...
    articles: [
      {
        ...
        content: `
          ...
          <ul>
            <li><strong>提示词市场</strong>：发布自己的写作 skills，被其他用户使用时获得收益。</li>
    ...
    articles: [
      ...
      },
      {
        ...
        content: `
          ...
          <p>申报审核通过后，金额会累加进「自媒体收入榜」，每月前 10 名可获得 1000 创作币奖励。</p>
        `
      },
      {
        id: 'how-leaderboard',
    ...
    articles: [
      {
        ...
        content: `
          <p>创作币是爱创作平台的虚拟货币。</p>
          <p>你可以通过 提示词市场、排行榜、邀请返利等方式获得创作币，也可以在平台内消费（如订阅会员、购买生成额度）。</p>
          <p>10 创作币 = 1 元人民币。</p>
        `
      },
      {
