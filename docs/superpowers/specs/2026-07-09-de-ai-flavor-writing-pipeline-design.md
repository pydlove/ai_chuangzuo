...
**目的**：针对第 7 阶段清单改写，不全篇重写。

**AI 调用**：✅ AI

**输入**：第 7 阶段问题清单 + 第 6 阶段产出的改写后初稿
...
完整 10 阶段流程中，**只有 8 个阶段会调用 AI**（第 1、5 阶段是程序化，不调 AI）。AI 调用次数 8-14 次（视第 7 阶段外部审视选几个读者而定）。
